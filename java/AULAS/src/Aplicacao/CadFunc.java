...
public class CadFunc {
	...
	public static void main(String[] args) {
		...
		if (func1.calcularIdade() < func2.calcularIdade()) {
			System.out.printf("%s %s %s é a pessoa mais velha", func2.trasArtigo().toUpperCase(), func2.tratamento(), func2.nome);
		} else {
			System.out.printf("%s %s %s é a pessoa mais velha", func1.trasArtigo().toUpperCase(), func1.tratamento(), func1.nome);
		}
		leia.close();
	}
}
